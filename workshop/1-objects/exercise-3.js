...
console.log('Chuck Taylor javascript ability: ', staffMembers[3].skillLevels.javascript);

staffMembers.forEach(function(element) {
  if (element.name === 'Chuck Taylor') {
    console.log(element.skillLevels.javascript);
  }
})